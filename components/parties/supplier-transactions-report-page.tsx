...
interface SupplierTransactionsReportPageProps {
    open: boolean
    onClose: () => void
    transactions: AllSupplierTransactionRow[] | null
    loading: boolean
}

export function SupplierTransactionsReportPage({
    open,
    onClose,
    transactions,
    loading,
}: SupplierTransactionsReportPageProps) {
    ...
    }, [transactions, fromDateStr, toDateStr, search])
    ...
    return (
        <DialogPrimitive.Root open={open} onOpenChange={(next) => !next && onClose()}>
            <DialogPrimitive.Portal>
                ...
                >
                    <DialogPrimitive.Title className="sr-only">Supplier Transactions Report</DialogPrimitive.Title>
                    ...
                    >
                        ...
                        <h1 className="text-lg font-bold text-foreground truncate">View Report</h1>
                    </div>
                                ...
                                <>
                                    <div className="flex items-center justify-between rounded-xl border border-border bg-card px-4 py-3">
                                        ...
                                        <span
                                            className={cn(
                                                "text-lg font-bold",
                                                isGet ? "text-emerald-500" : "text-rose-500"
                                            )}
                                        >
