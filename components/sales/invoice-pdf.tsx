...
export function getInvoiceShareFilename(invoice: any): string {
    return buildShareFilename(invoice.party?.name || "Party", invoice.invoiceNumber || "Invoice")
}

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export async function buildInvoicePdfBlob(invoice: any, businessProfile: any): Promise<Blob> {
            ...
            <Page size="A4" style={S.page}>
                ...
                <View style={S.termsSignRow}>
                    ...
                    <View style={S.signBox}>
                        ...
                        {biz.signatureUrl ? (
                            <PdfImage src={biz.signatureUrl} style={{ width: 170, height: 62, objectFit: "fill", marginVertical: 4 }} />
                        ) : (
    ...
    return await pdf(<InvoiceDoc />).toBlob()
}
