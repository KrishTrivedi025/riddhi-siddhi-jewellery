    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          ...
          "bg-card text-foreground border border-border shadow-2xl",
          "p-6 text-sm outline-none sm:max-w-md",
          // Open animation
          "data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95",
          "data-open:slide-in-from-bottom-2 data-open:duration-250",
          // Close animation
          "data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
          "data-closed:slide-out-to-bottom-1 data-closed:duration-150",
          className
        )}
...
function AlertDialogAction({
  ...
  return (
    <AlertDialogPrimitive.Action
      ...
      className={cn(buttonVariants({ variant: "default" }), "h-10", className)}
      {...props}
    />
  )
}
