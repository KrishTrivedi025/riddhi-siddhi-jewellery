...
const paymentModes = [
    { value: "none", label: "No Initial Payment", icon: FileCheck },
...
export function PurchaseInvoicePayment({
    paymentMode,
    amountPaid,
    grandTotal,
    onModeChange,
    ...
    return (
        <div className="bg-card border border-border rounded-xl p-5 space-y-4">
            <div className="flex items-center justify-between">
                <h3 className="text-sm font-semibold text-foreground">Payment Made Note</h3>
                <Badge
                    className={`text-xs ${
                        status === "paid"
