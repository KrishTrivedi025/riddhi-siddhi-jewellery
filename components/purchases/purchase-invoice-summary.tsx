...
export function PurchaseInvoiceSummary({ items, isInterState }: InvoiceSummaryProps) {
    ...
    return (
        <div className="bg-card border border-border rounded-xl p-5 space-y-3">
            <h3 className="text-sm font-semibold text-foreground mb-3">Purchase Summary</h3>
